...
public final class Attribution {
  ...
  /**
   * The enum referencing the known confidence level, or {@link org.gedcomx.record.types.ConfidenceLevel#OTHER} if not known.
   *
   * @return The enum referencing the known confidence level, or {@link org.gedcomx.record.types.ConfidenceLevel#OTHER} if not known.
   */
  @XmlTransient
  @JsonIgnore
