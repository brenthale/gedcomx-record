...
import org.gedcomx.record.types.ResourceFragmentParameter;
import org.gedcomx.record.types.ResourceType;
...
public class ResourceReference implements SupportsExtensionAttributes, SupportsExtensionElements {
  ...
  @JsonProperty
  private TypeReference<ResourceType> type;  private URI resource;
  ...
  /**
   * The enum referencing the known type of the resource being referenced, or {@link org.gedcomx.record.types.ResourceType#OTHER} if not known.
   *
   * @return The enum referencing the known type of the source reference, or {@link org.gedcomx.record.types.ResourceType#OTHER} if not known.
   */
  @XmlTransient
  @JsonIgnore
